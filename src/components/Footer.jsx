      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4">
              <span className="text-2xl font-bold text-green-400">Fruitopia</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your premier destination for fresh, organic fruits and healthy lifestyle products. 
              We bring nature's finest directly to your doorstep.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/plans" className="text-gray-300 hover:text-green-400 transition-colors">Plans</Link></li>
              <li><Link to="/details" className="text-gray-300 hover:text-green-400 transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">Customer Service</a></li>
            </ul>
          </div>
        </div>
